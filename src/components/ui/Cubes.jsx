...
/**
 * Cubes (React Bits) — a grid of 3D cubes that tilt toward the pointer and
 * ripple color outward on click. Ported verbatim except for monochrome defaults
 * (white edges, near-black faces) and a flexible square wrapper. Pass
 * autoAnimate={false} under prefers-reduced-motion to stop the idle drift.
 */
const Cubes = ({
  gridSize = 8,
  cubeSize,
  ...
  return (
    <div className="relative aspect-square w-full" style={wrapperStyle}>
